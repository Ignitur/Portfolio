  ...
  return (
		<div className="mx-[5%] mt-2 pb-6 bg-green-950 flex flex-col">
			<section className="min-w-[55%] pt-20">
				<h1 className="mx-8 text-6xl font-mono bg-cyan-300/20 w-auto">Hello there!</h1>
				<h3 className="mx-10 mt-2 text-4xl">My name is <span className="font-semibold text-red-500 px-1 bg-white/70 rounded-2xl">Maurszky Michael</span></h3>
			...
			<section className="flex md:px-30 justify-between items-start pb-8 px-0 mt-4 gap-4 border-1 overflow-scroll
				 md:overflow-hidden " >
				<FAQItem
